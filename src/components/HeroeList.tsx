...
const HeroList = () => {
  ...
  return (
    <div className="container mx-auto mt-8">
      <h1 className="text-3xl font-bold underline">Heróis</h1>
      ...
      <form>
        <div className="flex gap-3">
          ...
          <button
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button"
      ...
      <ul className="list-disc">
        {heroes.map((hero) => (
          <li key={hero.Id} className="flex gap-6 items-center">
            {hero.Name} - {hero.Category.Name}
            <button
              onClick={() => handleRemove(hero.Id)}
              className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-2 py-2 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 inline-flex items-center"
              title="Remover herói"
            >
